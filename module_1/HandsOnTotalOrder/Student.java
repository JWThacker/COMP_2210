...
public class Student implements Comparable<Student> {
    ...
    public int compareTo(Student s) {
        ...
        if (cmp == 0) cmp = this.fname.compareTo(s.fname);
        
        if (cmp == 0) {
           Integer thisSectionDmmy = (Integer) this.section;
           Integer thatSectionDmmy = (Integer) s.section;
           cmp = thisSectionDmmy.compareTo(thatSectionDmmy);
        }
