...
/**
* The selector class implements certain methods that are useful for arrays.
* The exact methods are found below, but a couple of examples are the min and
* max methods which return the minimum and maximum element in a specific array.
*
...
public class Selector {
   ...
   * @return min - the minimum of the elements of the array.
   */
   ...
   *
   * @param a - an array of integers.
   * @return max - the maximum of the elements of the array.
   */
